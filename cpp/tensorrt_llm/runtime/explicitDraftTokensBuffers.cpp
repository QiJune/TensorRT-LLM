    ...
    ModelConfig const& modelConfig, WorldConfig const& worldConfig)
{
    ...
    positionIds = manager.gpu(ITensor::makeShape({maxNumSequences * maxDecodingTokens}), tensorrt_llm::DataType::kINT32);
    ...
    runtime::WorldConfig const& worldConfig)
{
    ...
    engineOutputs.nextGenerationLengths = manager.emptyTensor(runtime::MemoryType::kGPU, tensorrt_llm::DataType::kINT32);
