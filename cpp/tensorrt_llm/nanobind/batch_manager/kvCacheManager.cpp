...
void tb::kv_cache_manager::KVCacheManagerBindings::initBindings(nb::module_& m)
{
    ...
    nb::class_<tbk::PoolConfiguration>(m, "PoolConfiguration")
        .def(nb::init<>())
        .def(nb::init<SizeType32, SizeType32, tensorrt_llm::DataType>(), nb::arg("window_size"), nb::arg("size_per_head"),
            nb::arg("dtype"))
    ...
    nb::class_<tbk::KVCacheManager, tbk::BaseKVCacheManager>(m, "KVCacheManager")
        .def(nb::init<std::vector<SizeType32> const&, SizeType32, SizeType32,
                 ...
                 std::vector<SizeType32> const&, tensorrt_llm::DataType, SizeType32, int64_t, SizeType32, SizeType32, bool,
