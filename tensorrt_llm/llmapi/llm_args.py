...
TORCH_LLMARGS_EXPLICIT_DOCSTRING = generate_api_docs_as_docstring(TorchLlmArgs,
                                                                  indent=' ' *
                                                                  4)
# The legacy TensorRT backend has been removed; keep this alias so existing
# importers continue to resolve. It now reflects the PyTorch LlmArgs.
TRT_LLMARGS_EXPLICIT_DOCSTRING = TORCH_LLMARGS_EXPLICIT_DOCSTRING
