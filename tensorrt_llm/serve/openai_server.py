...
# Kept in the import-light strict_mode module so the engine-client pipeline
# applies the same strict-tool mutation before its eligibility check;
# re-exported here for the historical name.
from tensorrt_llm.serve.tool_parser.strict_mode import \
    build_tool_strict_guided_decoding_params as \
...
class OpenAIServer(_VideoRoutesMixin):
    ...
    def _maybe_create_engine_pipeline(self):
        ...
        return OpenAIServingPipeline(
            ...
            gather_generation_logits=getattr(args, "gather_generation_logits",
                                             False),
        )
