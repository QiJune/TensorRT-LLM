...
class TensorWrapper:
    ...
    @staticmethod
    def from_trt_desc(desc, pointer: int):
        # TensorRT-only helper retained for the legacy plugin path; the dtype
        # conversion is imported lazily so this module stays free of a
        # module-level ``tensorrt`` import.
        from ._trt_utils import trt_dtype_to_torch
